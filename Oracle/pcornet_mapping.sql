...
*/ 
delete from "&&i2b2_meta_schema".pcornet_diag where c_fullname like '\PCORI_MOD\DX_ORIGIN\%';
INSERT INTO "&&i2b2_meta_schema".pcornet_diag (C_HLEVEL, C_FULLNAME, C_NAME, C_SYNONYM_CD, C_VISUALATTRIBUTES, C_TOTALNUM, C_BASECODE, C_METADATAXML, C_FACTTABLECOLUMN, C_TABLENAME, C_COLUMNNAME, C_COLUMNDATATYPE, C_OPERATOR, C_DIMCODE, C_COMMENT, C_TOOLTIP, M_APPLIED_PATH, UPDATE_DATE, DOWNLOAD_DATE, IMPORT_DATE, SOURCESYSTEM_CD, VALUETYPE_CD, M_EXCLUSION_CD, C_PATH, C_SYMBOL, PCORI_BASECODE)
  VALUES(1, '\PCORI_MOD\DX_ORIGIN\', 'Diagnosis Origin', 'N', 'DAE', NULL, '', '', 'modifier_cd', 'MODIFIER_DIMENSION', 'modifier_path', 'T', 'like', '\PCORI_MOD\DX_ORIGIN\', 'CDMv3.1', 'Source of the diagnosis information.Billing pertains to internal healthcare processes and data sources. Claim pertains to data from the bill fulfillment, generally data sources held by insurers and other health plans. Default mapping uses sourcesystem_cd, so no extra modifier rows are used.', '\PCORI\DIAGNOSIS\%', DATE '2017-06-26', DATE '2017-06-26', DATE '2017-06-26', 'PCORNET_CDMv3.1', NULL, NULL, '\PCORI_MOD\', 'DX_ORIGIN', '');
INSERT INTO "&&i2b2_meta_schema".pcornet_diag (C_HLEVEL, C_FULLNAME, C_NAME, C_SYNONYM_CD, C_VISUALATTRIBUTES, C_TOTALNUM, C_BASECODE, C_METADATAXML, C_FACTTABLECOLUMN, C_TABLENAME, C_COLUMNNAME, C_COLUMNDATATYPE, C_OPERATOR, C_DIMCODE, C_COMMENT, C_TOOLTIP, M_APPLIED_PATH, UPDATE_DATE, DOWNLOAD_DATE, IMPORT_DATE, SOURCESYSTEM_CD, VALUETYPE_CD, M_EXCLUSION_CD, C_PATH, C_SYMBOL, PCORI_BASECODE)
  VALUES(2, '\PCORI_MOD\DX_ORIGIN\OD\', 'Order', 'N', 'RAE', NULL, 'DX_ORIGIN:OD', '', 'sourcesystem_cd', 'MODIFIER_DIMENSION', 'modifier_path', 'T', 'like', '\PCORI_MOD\DX_ORIGIN\OD\', 'CDMv3.1', 'Order', '\PCORI\DIAGNOSIS\%', DATE '2017-06-26', DATE '2017-06-26', DATE '2017-06-26', 'PCORNET_CDMv3.1', NULL, NULL, '\PCORI_MOD\DX_ORIGIN\', 'OD', 'OD');
INSERT INTO "&&i2b2_meta_schema".pcornet_diag (C_HLEVEL, C_FULLNAME, C_NAME, C_SYNONYM_CD, C_VISUALATTRIBUTES, C_TOTALNUM, C_BASECODE, C_METADATAXML, C_FACTTABLECOLUMN, C_TABLENAME, C_COLUMNNAME, C_COLUMNDATATYPE, C_OPERATOR, C_DIMCODE, C_COMMENT, C_TOOLTIP, M_APPLIED_PATH, UPDATE_DATE, DOWNLOAD_DATE, IMPORT_DATE, SOURCESYSTEM_CD, VALUETYPE_CD, M_EXCLUSION_CD, C_PATH, C_SYMBOL, PCORI_BASECODE)
  VALUES(2, '\PCORI_MOD\DX_ORIGIN\BI\', 'Billing', 'N', 'RAE', NULL, 'DX_ORIGIN:BI', '', 'sourcesystem_cd', 'MODIFIER_DIMENSION', 'modifier_path', 'T', 'like', '\PCORI_MOD\DX_ORIGIN\BI\', 'CDMv3.1', 'Billing', '\PCORI\DIAGNOSIS\%', DATE '2017-06-26', DATE '2017-06-26', DATE '2017-06-26', 'PCORNET_CDMv3.1', NULL, NULL, '\PCORI_MOD\DX_ORIGIN\', 'BI', 'BI');
INSERT INTO "&&i2b2_meta_schema".pcornet_diag (C_HLEVEL, C_FULLNAME, C_NAME, C_SYNONYM_CD, C_VISUALATTRIBUTES, C_TOTALNUM, C_BASECODE, C_METADATAXML, C_FACTTABLECOLUMN, C_TABLENAME, C_COLUMNNAME, C_COLUMNDATATYPE, C_OPERATOR, C_DIMCODE, C_COMMENT, C_TOOLTIP, M_APPLIED_PATH, UPDATE_DATE, DOWNLOAD_DATE, IMPORT_DATE, SOURCESYSTEM_CD, VALUETYPE_CD, M_EXCLUSION_CD, C_PATH, C_SYMBOL, PCORI_BASECODE)
  VALUES(2, '\PCORI_MOD\DX_ORIGIN\NI\', 'zz No Information', 'N', 'RIE', NULL, 'DX_ORIGIN:NI', '', 'sourcesystem_cd', 'MODIFIER_DIMENSION', 'modifier_path', 'T', 'like', '\PCORI_MOD\DX_ORIGIN\NI\', 'CDMv3.1', 'No information: A data field is present in the source system, but the source value is null or blank.', '\PCORI\DIAGNOSIS\%', DATE '2017-06-26', DATE '2017-06-26', DATE '2017-06-26', 'PCORNET_CDMv3.1', NULL, NULL, '\PCORI_MOD\DX_ORIGIN\', 'NI', ':NI');
INSERT INTO "&&i2b2_meta_schema".pcornet_diag (C_HLEVEL, C_FULLNAME, C_NAME, C_SYNONYM_CD, C_VISUALATTRIBUTES, C_TOTALNUM, C_BASECODE, C_METADATAXML, C_FACTTABLECOLUMN, C_TABLENAME, C_COLUMNNAME, C_COLUMNDATATYPE, C_OPERATOR, C_DIMCODE, C_COMMENT, C_TOOLTIP, M_APPLIED_PATH, UPDATE_DATE, DOWNLOAD_DATE, IMPORT_DATE, SOURCESYSTEM_CD, VALUETYPE_CD, M_EXCLUSION_CD, C_PATH, C_SYMBOL, PCORI_BASECODE)
  VALUES(2, '\PCORI_MOD\DX_ORIGIN\OT\', 'zz Other', 'N', 'RAE', NULL, 'DX_ORIGIN:OT', '', 'sourcesystem_cd', 'MODIFIER_DIMENSION', 'modifier_path', 'T', 'like', '\PCORI_MOD\DX_ORIGIN\OT\', 'CDMv3.1', 'Other: A data field is present in the source system, but the source value cannot be mapped to the CDM.', '\PCORI\DIAGNOSIS\%', DATE '2017-06-26', DATE '2017-06-26', DATE '2017-06-26', 'PCORNET_CDMv3.1', NULL, NULL, '\PCORI_MOD\DX_ORIGIN\', 'OT', 'OT');
INSERT INTO "&&i2b2_meta_schema".pcornet_diag (C_HLEVEL, C_FULLNAME, C_NAME, C_SYNONYM_CD, C_VISUALATTRIBUTES, C_TOTALNUM, C_BASECODE, C_METADATAXML, C_FACTTABLECOLUMN, C_TABLENAME, C_COLUMNNAME, C_COLUMNDATATYPE, C_OPERATOR, C_DIMCODE, C_COMMENT, C_TOOLTIP, M_APPLIED_PATH, UPDATE_DATE, DOWNLOAD_DATE, IMPORT_DATE, SOURCESYSTEM_CD, VALUETYPE_CD, M_EXCLUSION_CD, C_PATH, C_SYMBOL, PCORI_BASECODE)
  VALUES(2, '\PCORI_MOD\DX_ORIGIN\CL\', 'Claim', 'N', 'RAE', NULL, 'DX_ORIGIN:CL', '', 'sourcesystem_cd', 'MODIFIER_DIMENSION', 'modifier_path', 'T', 'like', '\PCORI_MOD\DX_ORIGIN\CL\', 'CDMv3.1', 'Claim', '\PCORI\DIAGNOSIS\%', DATE '2017-06-26', DATE '2017-06-26', DATE '2017-06-26', 'PCORNET_CDMv3.1', NULL, NULL, '\PCORI_MOD\DX_ORIGIN\', 'CL', 'CL');
INSERT INTO "&&i2b2_meta_schema".pcornet_diag (C_HLEVEL, C_FULLNAME, C_NAME, C_SYNONYM_CD, C_VISUALATTRIBUTES, C_TOTALNUM, C_BASECODE, C_METADATAXML, C_FACTTABLECOLUMN, C_TABLENAME, C_COLUMNNAME, C_COLUMNDATATYPE, C_OPERATOR, C_DIMCODE, C_COMMENT, C_TOOLTIP, M_APPLIED_PATH, UPDATE_DATE, DOWNLOAD_DATE, IMPORT_DATE, SOURCESYSTEM_CD, VALUETYPE_CD, M_EXCLUSION_CD, C_PATH, C_SYMBOL, PCORI_BASECODE)
  VALUES(2, '\PCORI_MOD\DX_ORIGIN\UN\', 'zz Unknown', 'N', 'RAE', NULL, 'DX_ORIGIN:UN', '', 'sourcesystem_cd', 'MODIFIER_DIMENSION', 'modifier_path', 'T', 'like', '\PCORI_MOD\DX_ORIGIN\UN\', 'CDMv3.1', 'Unknown: A data field is present in the source system, but the source value explicitly denotes an unknown value.', '\PCORI\DIAGNOSIS\%', DATE '2017-06-26', DATE '2017-06-26', DATE '2017-06-26', 'PCORNET_CDMv3.1', NULL, NULL, '\PCORI_MOD\DX_ORIGIN\', 'UN', 'UN');
...
/* Insert child KUH|COMPONENT_ID nodes, setting pcori_basecode, and c_path to
   that of it's parent. */
whenever sqlerror continue;
drop table terminal_loinc_codes;
whenever sqlerror exit;
   
create table terminal_loinc_codes as
...
-- LOINC codes without children LOINC codes
select clc.*
