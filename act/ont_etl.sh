...
sqlplus $USERNAME/$PASSWORD@$SID @create_metadata_tables_from_shrine_ont.sql $metadata_schema $shrine_ont_schema
...
sqlplus $USERNAME/$PASSWORD@$SID @demographics_mapping.sql $metadata_schema
